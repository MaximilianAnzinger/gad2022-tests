...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Yes, it is.
    The trick is to make sure each of your method runs in either constant, logarithmic or linear time.
    If any of your methods run in O(n*log(n)) or O(n^2) time, these tests might fail.
    Even the insert method and whatever method you're using to rebalance the tree should run in constant or linear time.
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    void performanceLoop2(boolean insertRandomly) {
        ...
        for (int i = 1; i <= elements; i++) {
            tree.insert(insertRandomly ? random.nextInt(0, elements) : i);
            if (!tree.validAVL()) {
